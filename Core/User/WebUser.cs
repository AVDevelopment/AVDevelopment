...
namespace AV.Development.Core.User
{
    ...
    /// <summary>
    /// User object for table 'web_user'.
    /// </summary>
    public class WebUser : IUser, ICloneable
    {
        ...
        public WebUser(string pFirstName, string pLastName, string pUserName, byte[] pPassword, string pEmail, string pImage, string psaltPassword, string pOldPassword, int pWebId, bool pIsactive, bool pIsPwdreset, DateTime pRegistrationDate, DateTime pLastLogin, int pCurrentwebID, int pUserType)
        {
