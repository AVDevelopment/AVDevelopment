...
using AV.Development.Dal.Mongo.Helpers;
...
namespace MongoDragons.Repository.Concrete
{
    public class MongoRepository : IRepository
    {
        ...
        {
            _provider = Mongo.Create(ConfigurationManager.ConnectionStrings["mongodb"].ConnectionString);
        }
        ...
        public IQueryable<T> FilterCondition<T>(System.Linq.Expressions.Expression<Func<T, bool>> expression) where T : class, new()
        {
